-- Allow eligible managers to nominate unclaimed players as soon as the
-- Candidate Card deadline is locked, including while restricted ties resolve.
...
SET metadata_value = '52',
    updated_at_ms = CASE
      WHEN updated_at_ms < 52 THEN 52
      ELSE updated_at_ms
    END
WHERE metadata_key = 'data_model_version'
  AND metadata_value = '51';

...
function getRepositoryCatalogForSchemaVersion(schemaVersion) {
  ...
  return [54, 55, 56].includes(schemaVersion) ? SCHEMA_54_REPOSITORY_CATALOG : schemaVersion < 62 ? REPOSITORY_CATALOG.filter(({ tableName }) => tableName !== "trade_participants") : REPOSITORY_CATALOG;
}
